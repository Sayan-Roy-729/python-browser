...
# from PyQt5.QtWidgets import QApplication, QMainWindow, QMenu, QAction, QTabWidget, QWebEngineView
import os
import sys
...
class MainWindow(QMainWindow):
	...
	def show_context_menu(self, pos):
		menu = QMenu(self)
		link_action = self.webview.page().action(QWebEnginePage.OpenLinkInNewWindow)
	...
	def open_link_in_new_tab(self):
		link_url = self.webview.page().action(QWebEnginePage.OpenLinkInNewWindow).data()
